      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">13. Grievance Redressal</h2>
              <p className="text-gray-700 mb-4">
              ...
              <div className="bg-gray-50 p-4 rounded-lg mb-4">
                ...
                <p className="text-gray-700 mb-1">Address: 11/2, Ramar Koil Street, Hosur, Tamil Nadu, India, PIN-635109</p>
                <p className="text-gray-700">We will respond to your grievance within 30 days from the date of receipt.</p>
              </div>
            </section>
