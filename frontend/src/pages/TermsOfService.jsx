        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">7.4 Price Changes</h3>
              <p className="text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">8. Medical and Health Disclaimer</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">12.2 Dispute Resolution</h3>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-gray-700 mb-2"><strong>TheraP Track</strong></p>
                <p className="text-gray-700 mb-1">Email: support@theraptrack.com</p>
                <p className="text-gray-700 mb-1">Phone: +919742991324</p>
                <p className="text-gray-700">Address: 11/2, Ramar Koil Street, Hosur, Tamil Nadu, India, PIN-635109</p>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">18. Acknowledgement</h2>
              <p className="text-gray-700">
