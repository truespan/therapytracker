                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-center">
                      {org.theraptrack_controlled ? (
                        <div className="flex items-center justify-center">
                          <label className="relative inline-flex items-center cursor-not-allowed opacity-75" title="Edit organization to change this setting">
                            <input
                              type="checkbox"
                          ...
                          <span className="ml-2 text-xs text-gray-500 dark:text-dark-text-tertiary" title="Edit organization to change this setting">
                            (Edit to change)
                          </span>
                        </div>
                      ) : (
