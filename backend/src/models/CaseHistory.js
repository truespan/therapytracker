...
class CaseHistory {
  ...
  static async createOrUpdate(caseHistoryData, client = null) {
    ...
    const existing = await this.findByUserIdAndPartnerId(user_id, partnerId);
    ...
    if (existing) {
      ...
      const updateQuery = `
        UPDATE case_histories SET
          ...
          family_history_home_atmosphere = COALESCE($50, family_history_home_atmosphere),
          family_history_sibling_rivalry = COALESCE($51, family_history_sibling_rivalry),
          personal_history_birth_date = COALESCE($52, personal_history_birth_date),
          personal_history_birth_place = COALESCE($53, personal_history_birth_place),
          personal_history_mother_condition_pregnancy = COALESCE($54, personal_history_mother_condition_pregnancy),
          personal_history_mother_condition_delivery = COALESCE($55, personal_history_mother_condition_delivery),
          personal_history_mother_condition_after_delivery = COALESCE($56, personal_history_mother_condition_after_delivery),
          personal_history_nature_of_delivery = COALESCE($57, personal_history_nature_of_delivery),
          personal_history_birth_weight = COALESCE($58, personal_history_birth_weight),
          personal_history_feeding_method = COALESCE($59, personal_history_feeding_method),
          personal_history_milestones_physical_development = COALESCE($60, personal_history_milestones_physical_development),
          personal_history_neurotic_symptoms_childhood = COALESCE($61, personal_history_neurotic_symptoms_childhood),
          personal_history_health_childhood = COALESCE($62, personal_history_health_childhood),
          personal_history_childhood_disorders = COALESCE($63, personal_history_childhood_disorders),
          personal_history_home_atmosphere_childhood = COALESCE($64, personal_history_home_atmosphere_childhood),
          scholastic_age_standard_admission = COALESCE($65, scholastic_age_standard_admission),
          scholastic_highest_grade_completed = COALESCE($66, scholastic_highest_grade_completed),
          scholastic_change_institution_cause = COALESCE($67, scholastic_change_institution_cause),
          scholastic_academic_performance = COALESCE($68, scholastic_academic_performance),
          scholastic_reason_discontinuation = COALESCE($69, scholastic_reason_discontinuation),
          scholastic_adjustment_school = COALESCE($70, scholastic_adjustment_school),
          scholastic_peer_relationships = COALESCE($71, scholastic_peer_relationships),
          scholastic_disciplinary_problems = COALESCE($72, scholastic_disciplinary_problems),
          scholastic_further_education = COALESCE($73, scholastic_further_education),
          scholastic_extracurricular_activities = COALESCE($74, scholastic_extracurricular_activities),
          vocation_age_starting = COALESCE($75, vocation_age_starting),
          vocation_nature_position = COALESCE($76, vocation_nature_position),
          vocation_change_job_cause = COALESCE($77, vocation_change_job_cause),
          vocation_nature_duration_present_job = COALESCE($78, vocation_nature_duration_present_job),
          vocation_working_past_year = COALESCE($79, vocation_working_past_year),
          vocation_work_record = COALESCE($80, vocation_work_record),
          vocation_adjustment_peers_authority = COALESCE($81, vocation_adjustment_peers_authority),
          vocation_work_position_ambition = COALESCE($82, vocation_work_position_ambition),
          menstrual_menarche_age = COALESCE($83, menstrual_menarche_age),
          menstrual_information_acquired_from = COALESCE($84, menstrual_information_acquired_from),
          menstrual_reaction = COALESCE($85, menstrual_reaction),
          menstrual_associated_discomfort = COALESCE($86, menstrual_associated_discomfort),
          menstrual_regularity = COALESCE($87, menstrual_regularity),
          menstrual_last_date = COALESCE($88, menstrual_last_date),
          menstrual_amenorrhea = COALESCE($89, menstrual_amenorrhea),
          menstrual_menopause = COALESCE($90, menstrual_menopause),
          menstrual_related_symptoms = COALESCE($91, menstrual_related_symptoms),
          sexual_source_information = COALESCE($92, sexual_source_information),
          sexual_age_acquisition = COALESCE($93, sexual_age_acquisition),
          sexual_reaction_attitude = COALESCE($94, sexual_reaction_attitude),
          sexual_libido = COALESCE($95, sexual_libido),
          sexual_masturbation = COALESCE($96, sexual_masturbation),
          sexual_fantasy = COALESCE($97, sexual_fantasy),
          sexual_heterosexual_homosexual = COALESCE($98, sexual_heterosexual_homosexual),
          sexual_pre_marital_extra_marital = COALESCE($99, sexual_pre_marital_extra_marital),
          sexual_deviance = COALESCE($100, sexual_deviance),
          marital_date_of_marriage = COALESCE($101, marital_date_of_marriage),
          marital_type = COALESCE($102, marital_type),
          marital_age_at_marriage = COALESCE($103, marital_age_at_marriage),
          marital_partner_age_at_marriage = COALESCE($104, marital_partner_age_at_marriage),
          marital_spouse_education = COALESCE($105, marital_spouse_education),
          marital_spouse_occupation = COALESCE($106, marital_spouse_occupation),
          marital_adjustment = COALESCE($107, marital_adjustment),
          marital_sexual_life = COALESCE($108, marital_sexual_life),
          marital_number_children_details = COALESCE($109, marital_number_children_details),
          marital_extra_marital_relations = COALESCE($110, marital_extra_marital_relations),
          marital_other_details = COALESCE($111, marital_other_details),
          forensic_history = COALESCE($112, forensic_history),
          medical_history_nature_illness = COALESCE($113, medical_history_nature_illness),
          medical_history_doctors_consulted = COALESCE($114, medical_history_doctors_consulted),
          medical_history_medication = COALESCE($115, medical_history_medication),
          medical_history_hospitalization = COALESCE($116, medical_history_hospitalization),
          medical_history_degree_recovery = COALESCE($117, medical_history_degree_recovery),
          medical_history_accidents_operations = COALESCE($118, medical_history_accidents_operations),
          premorbid_personality_self = COALESCE($119, premorbid_personality_self),
          premorbid_personality_sociability = COALESCE($120, premorbid_personality_sociability),
          premorbid_personality_responsibility = COALESCE($121, premorbid_personality_responsibility),
          premorbid_personality_work_leisure = COALESCE($122, premorbid_personality_work_leisure),
          premorbid_personality_mood = COALESCE($123, premorbid_personality_mood),
          premorbid_personality_character = COALESCE($124, premorbid_personality_character),
          premorbid_personality_attitudes_standards = COALESCE($125, premorbid_personality_attitudes_standards),
          premorbid_personality_habits = COALESCE($126, premorbid_personality_habits),
          premorbid_personality_adjustments = COALESCE($127, premorbid_personality_adjustments),
          premorbid_personality_food_sleep_pattern = COALESCE($128, premorbid_personality_food_sleep_pattern),
          fantasy_life = COALESCE($129, fantasy_life),
          present_illness_evolution_symptoms = COALESCE($130, present_illness_evolution_symptoms),
          present_illness_mode_onset = COALESCE($131, present_illness_mode_onset),
          present_illness_course = COALESCE($132, present_illness_course),
          present_illness_progress = COALESCE($133, present_illness_progress),
          present_illness_sleep_change = COALESCE($134, present_illness_sleep_change),
          present_illness_appetite_change = COALESCE($135, present_illness_appetite_change),
          present_illness_sexual_interest_change = COALESCE($136, present_illness_sexual_interest_change),
          present_illness_energy_change = COALESCE($137, present_illness_energy_change),
          present_illness_negative_history = COALESCE($138, present_illness_negative_history),
          present_illness_treatment_history = COALESCE($139, present_illness_treatment_history),
          problem_conception = COALESCE($140, problem_conception),
          patient_view_responsibility = COALESCE($141, patient_view_responsibility),
          patient_pervasive_mood = COALESCE($142, patient_pervasive_mood),
          impact_patient_attitude = COALESCE($143, impact_patient_attitude),
          role_functioning_biological = COALESCE($144, role_functioning_biological),
          personal_care_negative_symptoms = COALESCE($145, personal_care_negative_symptoms),
          additional_information = COALESCE($146, additional_information)
        WHERE user_id = $147 AND partner_id = $148
        RETURNING *
      `;
